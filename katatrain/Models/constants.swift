...
let AI_WEIGHTED = "ai:p:weighted"
let AI_JIGO = "ai:jigo"
let AI_ANTIMIRROR = "ai:antimirror"
let AI_POLICY = "ai:policy"
let AI_PICK = "ai:p:pick"
let AI_LOCAL = "ai:p:local"
let AI_TENUKI = "ai:p:tenuki"
let AI_INFLUENCE = "ai:p:influence"
let AI_TERRITORY = "ai:p:territory"
let AI_RANK = "ai:p:rank"
let AI_SIMPLE_OWNERSHIP = "ai:simple"
let AI_SETTLE_STONES = "ai:settle"


let AI_STRATEGIES_ENGINE = [AI_DEFAULT, AI_HANDICAP, AI_SCORELOSS, AI_SIMPLE_OWNERSHIP, AI_JIGO, AI_ANTIMIRROR]
let AI_STRATEGIES_PICK = [AI_PICK, AI_LOCAL, AI_TENUKI, AI_INFLUENCE, AI_TERRITORY, AI_RANK]
let AI_STRATEGIES_POLICY = [AI_WEIGHTED, AI_POLICY] + AI_STRATEGIES_PICK
let AI_STRATEGIES = AI_STRATEGIES_ENGINE + AI_STRATEGIES_POLICY
let AI_STRATEGIES_RECOMMENDED_ORDER = [
    AI_DEFAULT,
    AI_RANK,
    AI_HANDICAP,
    AI_SIMPLE_OWNERSHIP,
